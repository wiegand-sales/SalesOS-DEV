...
def row_to_payload(row, employee_id):
    ...
    return {
        ...
        "not_successful": parse_de_int(g("oem_nerf")),
        "not_possible": parse_de_int(g("oem_nm")),
        "conv_oem": parse_de_int(g("oem_gesamt")),
        "conv_tw": parse_de_int(g("oem_tw")),
        "conv_yes": parse_de_int(g("oem_yes")),
        "conv_sy": parse_de_int(g("oem_sy")),
        "conv_my": parse_de_int(g("oem_my")),
        "upsells": parse_de_int(g("ups_yes")),
        "wka": wka_gesamt,
        "opt_gesamt": opt_gesamt,
        "marge_oem": marge_oem,
        "marge_upsell": marge_upsell,
        "marge_wka": marge_wka,
        "marge_gesamt": marge_oem + marge_upsell + marge_wka,
        "cr_oem": parse_de_number(g("oem_cr")),
        "cr_teilweise": parse_de_number(g("oem_tw_cr")),
        "cr_yes": parse_de_number(g("oem_yes_cr")),
        "cr_super_yes": parse_de_number(g("oem_sy_cr")),
        "cr_mega_yes": parse_de_number(g("oem_my_cr")),
